...
public final class ExpjTraceContext {
    ...
    public ExpjTraceContext(byte[] traceId, byte[] parentSpanId, boolean sampled) {
    ...
    public boolean equals(Object other) {
        return other instanceof ExpjTraceContext context
