...
public final class BenchmarkMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (var client = ExpjClient.connect(endpoint)) {
            ...
            int rounds = 100;
            int batchSize = 256;
            List<ExpjRequest> batch = java.util.stream.IntStream.range(0, batchSize)
                .mapToObj(ignored -> new ExpjRequest(1, PAYLOAD, Duration.ofSeconds(5)))
                .toList();
            long started = System.nanoTime();
            ...
            System.out.printf(
                "EXPJ benchmark %s: latency p50=%.1fµs p95=%.1fµs p99=%.1fµs, pipelined throughput=%.0f req/s%n",
                endpoint,
