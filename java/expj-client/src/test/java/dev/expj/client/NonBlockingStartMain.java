...
public final class NonBlockingStartMain {
    public static void main(String[] args) throws Exception {
        ...
        var client = ReconnectingExpjClient.start("tcp://127.0.0.1:9");
        ...
        try {
            ...
            if (!(error.getCause() instanceof ReconnectingExpjClient.BackendUnavailableException)) {
                throw error;
            }
        }
        System.out.println("EXPJ non-blocking start test passed in " + elapsedMillis + " ms");
    }
}
