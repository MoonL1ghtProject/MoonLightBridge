...
import ru.moonlightproject.bridge.client.MoonLightTelemetryProvider;
import io.sentry.ITransaction;
import io.sentry.ProfileLifecycle;
import io.sentry.Sentry;

/** Internal provider discovered automatically when moonlight-bridge-sentry is bundled. */
    ...
    static {
        ...
        try {
            Sentry.init(options -> {
                ...
                // The SDK default of 30 drops telemetry during even a small MoonLightBridge
            ...
            // cost while the MoonLightBridge connection is being established, never in RPC #1.
            if (CONFIG.profileSampleRate() > 0.0) {
                ITransaction warmup = Sentry.startTransaction("MoonLightBridge profiler warmup", "internal");
                warmup.finish();
            }
        } finally {
