...
record TelemetryBuildConfig(
    ...
    private static final String RESOURCE = "/META-INF/moonlight-bridge/telemetry.properties";
    ...
    static TelemetryBuildConfig load() {
        ...
        try (InputStream input = TelemetryBuildConfig.class.getResourceAsStream(RESOURCE)) {
            ...
            return new TelemetryBuildConfig(
                ...
                properties.getProperty("release", "moonlight-bridge@unknown"));
        } catch (IOException | IllegalArgumentException error) {
            System.getLogger("ru.moonlightproject.bridge.telemetry").log(
                System.Logger.Level.WARNING,
                "Invalid embedded MoonLightBridge telemetry configuration; using minimal policy",
                error);
            return minimal();
        }
    }
    ...
    private static TelemetryBuildConfig minimal() {
        return new TelemetryBuildConfig(0.001, 0.0, false, false, "production", "moonlight-bridge@unknown");
    }
}
